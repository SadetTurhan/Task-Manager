    ...
    return(
        <>
            <form className="loginForm">
                ...
                <label className="formLabelText" for="email">Your Email</label><input className="formInput"/>
                <label className="formLabelText" for="password">Your Password</label><input className="formInput"/>
